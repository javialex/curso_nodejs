...
* In your pull request, do not add documentation to `index.html` or re-build the minified `coffee-script1.js` file. We'll do those things before cutting a new release.